...
function updateFloatingTocSafeInset() {
  ...
  if (!wrap) return
  // Keep the floating TOC on a stable viewport anchor. Moving it exactly at the
  // page boundary makes trackpad/macOS overscroll look like an extra page bounce.
